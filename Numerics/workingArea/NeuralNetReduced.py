...
def TrainModel(model, dataset, validation_set, epochs, label_name, val_indices,
  ...
  es = tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience = 12, verbose=2)
...
def TrainTestNet(batch_size, train_size, train_batch, valid_size, valid_batch, test_size, test_batch, val_indices):
    Initialise()
